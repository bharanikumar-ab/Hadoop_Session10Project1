...
public class CasesByFBICode {
	 private static Logger logger = Logger.getLogger(CasesByFBICode.class);
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		Job job = new Job(config,"CasesByFBICode");
		job.setJarByClass(CasesByFBICode.class);
